# Hebrew fiction in English translation, US editions, 1948–2025

A bibliography of **417 Hebrew-language works of adult fiction published in English translation in US editions**, 1948–2025.

## The data

`hebrew-fiction-english-translation-US-editions-1948-2025.csv` — 417 rows, one per book, UTF-8, CRLF line endings.

| Column | Notes |
|---|---|
| `Year` | Year of the US edition, 1948–2025. No rows for 1949, 1950, 1953, 1954, 1959, 1964, 1965. |
| `Author` | Author as credited; 184 distinct authors. Translators are not recorded. |
| `Title` | English title of the US edition; 416 distinct strings. |
...
Most-represented publishers, among rows that record one: Toby Press (18), Schocken Books (11), Dalkey Archive (9), Houghton Mifflin Harcourt (9), HarperCollins (8), New Vessel Press (8).
...
| `USsurvey` | 197 | A survey of US editions covering 2004–2025 |
